...
with tab1:
    ...
    # read csv file
    uploaded_file = st.file_uploader("Füge die Absenzen Datei export.csv hinzu")
    ...
    if len(df_current_semester) ==0:
        ...
        st.text("Die Daten entsprechen jeweils nur dem ersten Absenzeintrag auf SAL und gibt keine Auskunft über die Dauer der Absenz an.")
